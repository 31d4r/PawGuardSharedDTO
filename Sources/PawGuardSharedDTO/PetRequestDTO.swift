...
public struct PetRequestDTO: Codable {
    ...
    public init(name: String, species: String, sex: String, petBreed: String, dateOfBirth: Double, color: String, castratedSterilized: String,  microchipNumber: String, microchipLocation: String, imageURL: String) {
        self.name = name
